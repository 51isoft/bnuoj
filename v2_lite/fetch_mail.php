<?php
	...
	if($nowuser== ""||$nowpass==""||!db_user_match($nowuser,$nowpass)||!db_mail_user_match($nowuser,$mailid)){
        ...
        echo "<div style='clear:both;margin:auto;font-weight:bold;text-align:center'><label id='mailtitle' style='display:none'>$title</label>Sender: <label id='mailsender'>$sender</label>";
        ...
        if ($nowuser==$reciever) $res=mysql_query($query);
    }
?>
