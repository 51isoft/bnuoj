...
?>
            ...
            <form class="clarform" method="post" action="#">
              <textarea name="answer" style="width:540px;height:150px;padding:0.7em"><?php echo $row[1]; ?></textarea><br />
...
?>
          <div class="center" style="margin-bottom:0"><a href="#" id="newquestion" class="button" style="color: #444">Post New Question</a></div>
        </div>
