...
<?php
            ...
            else if (db_contest_intermission($cid)) echo "<span class='crunning'>Intermission</span>";
            else if (db_contest_challenging($cid)) echo "<span class='crunning'>Challenging</span>";
            else if (db_contest_running($cid)) echo "<span class='crunning'>Running</span>";
            else {
                $canshow=false;
                echo "<span class='cscheduled'>Not Started</span>";
            }
?>
          </div>
<?php
...
<?php
            ...
            while (  $go = mysql_fetch_array($que) ) {
                ...
                echo "<tr>\n";
                echo "<td> $flag </td>\n";
                echo "<td><a href='javascript:void(0)' name='$go[2]' class='cprob_a'>",$go[1],"</a></td>\n";
                echo "<td><a href='javascript:void(0)' name='$go[2]' class='cprob_a'>",$title," </a></td>\n";
