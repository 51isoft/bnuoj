...
<a style="color:<?php echo $row[3]; ?>" class="send_a" suser="<?php echo $row[0]; ?>" slabel="<?php echo $row[1]; ?>" scid="<?php echo $cid; ?>"><?php echo "User: ".$row[0]."<br />Problem: ".$row[1]; ?></a>
</div>
<?php
      }
  }
