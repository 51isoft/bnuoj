...
?>
              ...
              <tr>
                ...
                <td>
                  ...
                  <?php echo $acnum; ?>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="javascript:void(0)" class="button" id="showac">Show all</a><a href="javascript:void(0)" class="button" id="hideac" style="display:none">Hide</a>
              ...
              <tr>
                ...
                <td>
                  <form id="compareform">
                    ...
                    <a href="javascript:void(0)" id="hidecompare" class="button" style="display:none">Hide</a>
                  </form>
...
<script type="text/javascript" src="pagejs/userinfo.js"></script>
