...
list($nac)=mysql_fetch_array(mysql_query("select count(*) from status where username='$name' and result like 'Accepted%'"));
...
$d[2]->on_click($ref."status.php?showname=$name&showres=Unaccepted");
