...
<form action='compare.php' method=get>
  <table width="40%" class='status'>
    <tr><td class='status'>
      比较 <input type='text' style='width:100px;height:24px;font:14px' name='name1' value='<?php echo $name1; ?>'> 和 <input type='text' style='width:100px;height:24px;font:14px' name='name2' value='<?php echo $name2; ?>'>的做题情况 <input type='submit' size=10 value='开始比较'>
    </td></tr>
  </table>
</form>
<table width=45%>
<?php
echo "<caption style='font-size:22px;'><a href='userinfo.php?name=$name1' style='font-size:22px;'>$name1</a> 和 <a href='userinfo.php?name=$name2' style='font-size:22px;'>$name2</a>的做题情况比较</caption>";
echo "<tr>";
echo "<th>只有<a href='userinfo.php?name=$name1'>$name1</a> 才做出来的题目列表:</th>";
echo "</tr>";
echo "<tr>";
echo "<td>";
for ($i=0;$i<$nonly1;$i++)
...
echo "</tr>";
echo "<tr>";
echo "<th>只有 <a href='userinfo.php?name=$name2'>$name2</a> 才做出来的题目列表:</th>";
echo "</tr>";
echo "<tr>";
echo "<td>";
for ($i=0;$i<$nonly2;$i++) 
...
echo "</tr>";
echo "<tr>";
echo "<th><a href='userinfo.php?name=$name1'>$name1</a> 和 <a href='userinfo.php?name=$name2'>$name2</a> 都做出来的题目列表:</th>";
echo "</tr>";
echo "<tr>";
echo "<td>";
...
echo "</tr>";
echo "<tr>";
echo "<th> 只有<a href='userinfo.php?name=$name1'>$name1</a> 做过，但是没做出来的题目列表:</th>";
echo "</tr>";
echo "<tr>";
echo "<td>";
...
echo "</tr>";
echo "<tr>";
echo "<th>只有 <a href='userinfo.php?name=$name2'>$name2</a> 做过，但是没做出来的题目列表:</th>";
echo "</tr>";
echo "<tr>";
echo "<td>";
...
echo "</tr>";
echo "<tr>";
echo "<th> <a href='userinfo.php?name=$name1'>$name1</a> 和 <a href='userinfo.php?name=$name2'>$name2</a> 都做过，但是没做出来的题目列表:</th>";
echo "</tr>";
echo "<tr>";
echo "<td>";
