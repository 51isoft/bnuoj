...
//                $pos2=stripos($content,$chr,$pos2);
                $chr="</h";
                $pos1=stripos($content,$chr,$pos2)+strlen($chr)+2;
                $pos2=stripos($content,"<h",$pos1);
...
//                $pos2=stripos($content,$chr,$pos2);
                $chr="</h";
                $pos1=stripos($content,$chr,$pos2)+strlen($chr)+2;
                $pos2=stripos($content,">Sample",$pos1)-3;
...
//            echo "Output: ".htmlspecialchars($oup)."<br>\n";die();
                ...
                $chr="<span style=\"font-family: Courier New,Courier,monospace;\">";
   ...
   //             echo "Sample In: <pre>".$sin."</pre><br>\n";die();
                ...
                $chr="<span style=\"font-family: Courier New,Courier,monospace;\">";
                $pos1=stripos($content,$chr,$pos2);
                $pos2=stripos($content,"</body>",$pos1);
                $sout=substr($content,$pos1,$pos2-$pos1);
                $sout=pimage($sout,$cate);
                //echo "Output: ".htmlspecialchars($oup)."<br>\n";
