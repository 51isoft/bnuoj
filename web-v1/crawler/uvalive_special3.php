...
//            echo $mark;
            ...
            $chr="<o:p></o:p></span></p>";
            $pos1=stripos($content,$chr,$pos2)+strlen($chr);
            $pos2=stripos($content,"<p class=MsoNormal style='margin-top:6.0pt'>",$pos1);
...
//                echo "Sample In: <pre>".$sin."</pre><br>\n";die();
                ...
                $chr="</p>";
                $pos1=stripos($content,$chr,$pos2);
                $pos2=stripos($content,"<![if !supportEmptyParas]>&nbsp;<![endif]>",$pos1);
                $sout=substr($content,$pos1,$pos2-$pos1);
                $sout=strtr(strip_tags($sout),$trans);
                //echo "Output: ".htmlspecialchars($oup)."<br>\n";
