...
$.fn.dataTableExt.oPagination.input={fnInit:function(a,b,c){var d=document.createElement("span");var e=document.createElement("span");var f=document.createElement("span");var g=document.createElement("span");var h=document.createElement("input");var i=document.createElement("span");var j=document.createElement("span");d.innerHTML=a.oLanguage.oPaginate.sFirst;e.innerHTML=a.oLanguage.oPaginate.sPrevious;f.innerHTML=a.oLanguage.oPaginate.sNext;g.innerHTML=a.oLanguage.oPaginate.sLast;d.className="paginate_button first";e.className="paginate_button previous";f.className="paginate_button next";g.className="paginate_button last";j.className="paginate_of";i.className="paginate_page";if(a.sTableId!==""){b.setAttribute("id",a.sTableId+"_paginate");e.setAttribute("id",a.sTableId+"_previous");e.setAttribute("id",a.sTableId+"_previous");f.setAttribute("id",a.sTableId+"_next");g.setAttribute("id",a.sTableId+"_last")}h.type="text";h.style.width="35px";h.style.display="inline";i.innerHTML="Page ";b.appendChild(d);b.appendChild(e);b.appendChild(i);b.appendChild(h);b.appendChild(j);b.appendChild(f);b.appendChild(g);$(d).click(function(){a.oApi._fnPageChange(a,"first");c(a)});$(e).click(function(){a.oApi._fnPageChange(a,"previous");c(a)});$(f).click(function(){a.oApi._fnPageChange(a,"next");c(a)});$(g).click(function(){a.oApi._fnPageChange(a,"last");c(a)});$(h).keyup(function(b){if(b.which==38||b.which==39){this.value++}else if((b.which==37||b.which==40)&&this.value>1){this.value--}if(this.value==""||this.value.match(/[^0-9]/)){return}var d=a._iDisplayLength*(this.value-1);if(d>a.fnRecordsDisplay()){a._iDisplayStart=(Math.ceil((a.fnRecordsDisplay()-1)/a._iDisplayLength)-1)*a._iDisplayLength;c(a);return}a._iDisplayStart=d;c(a)});$("span",b).bind("mousedown",function(){return false});$("span",b).bind("selectstart",function(){return false})},fnUpdate:function(a,b){if(!a.aanFeatures.p){return}var c=Math.ceil(a.fnRecordsDisplay()/a._iDisplayLength);var d=Math.ceil(a._iDisplayStart/a._iDisplayLength)+1;var e=a.aanFeatures.p;for(var f=0,g=e.length;f<g;f++){var h=e[f].getElementsByTagName("span");var i=e[f].getElementsByTagName("input");h[3].innerHTML=" of "+c;i[0].value=d}}}
