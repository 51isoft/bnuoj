...
?>
          <div class="slidediv" style="width:960px;margin:5px auto">
            ...
            <span class="maxval" style="display:none" name="<?= $has_cha==0?$fitimeu-$sttimeu:$cendtimeu-$sttimeu ?>"></span>
          </div>
<?php
    }
?>
      ...
      <div id="cstandingcontainer">
          ...
          <div class="tcenter currentstat">
            <label class="radio inline"><input type="radio" id="stat_dis_nick"><p>Display Nickname</p></label>&nbsp;&nbsp;&nbsp;&nbsp;
            <label class="radio inline"><input type="radio" id="stat_dis_user" checked><p>Display Username</p></label><br />
            <b>
