...
//die();
    for ($cid=$from;$cid<=$to;$cid++) {
        ...
        while (true) {
            $pid=$cid.$num;
            $res=mysql_query("select pid from problem where vname like 'CF' and vid like '$pid'");
...
//                echo "Title: ".$title."<br>\n";die()
                ...
                $pos2=strpos($content," seconds</div>",$pos1);
...
//                echo "Memory Limit: ".$mem_limit."<br>\n";die();
                ...
                $chr="<div class=\"legend\">";
                $pos1=strpos($content,$chr,$pos2)+strlen($chr);
                $pos2=strpos($content,"</div><div class=\"input-specification\">",$pos1);
...
//                echo "Desc: ".htmlspecialchars($desc)."<br>\n";die();
                ...
                $chr="Input</div>";
                $pos1=strpos($content,$chr,$pos2)+strlen($chr);
                $pos2=strpos($content,"</div><div class=\"output-specification\">",$pos1);
...
//                echo "Input: ".htmlspecialchars($inp)."<br>\n";
                ...
                $chr="Output</div>";
                $pos1=strpos($content,$chr,$pos2)+strlen($chr);
                $pos2=strpos($content,"</div><div class=\"sample-tests\">",$pos1);
...
*/
 ...
 //               echo "Sample Test: <pre>".$sin."</pre><br>\n";
                ...
                if (strpos($content,$chr,$pos2)!==false) {
                    $pos1=strpos($content,$chr,$pos2)+strlen($chr);
                    $pos2=strpos($content,"</div></div><p> </p>",$pos1);
